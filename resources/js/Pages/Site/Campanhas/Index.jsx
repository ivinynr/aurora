            ...
            <section className="max-w-6xl mx-auto px-6 pt-12 pb-24">
                ...
                <motion.form initial="hidden" animate="show" variants={fadeUp} onSubmit={buscar} className="mb-10 max-w-lg mx-auto">
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 px-4 py-3 rounded-xl border border-cream-300 bg-white text-sm text-bark-800 placeholder:text-bark-400 focus:border-terra-300 focus:ring-2 focus:ring-terra-100 transition-colors"
                        />
                ...
                {campanhas.data.length > 0 ? (
                    ...
                    <div className="text-center py-16">
                        <p className="font-serif text-xl text-bark-500 mb-2">Nenhuma campanha encontrada.</p>
                        <p className="text-sm text-bark-400">Tente buscar com outros termos ou volte mais tarde.</p>
                    </div>
                )}
            </section>
        </AppLayout>
